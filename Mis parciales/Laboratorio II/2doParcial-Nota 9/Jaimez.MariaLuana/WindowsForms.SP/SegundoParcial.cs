...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Jaimez Maria Luana");
            this.Text = "Jaimez Maria Luana";
        }
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            if (rta == DialogResult.OK)
            {
                ...
                text = file.ReadToEnd();
                this.txtVisorTickets.Text = text;
            }
        }
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            this.cn = new SqlConnection(@"Server=localhost\SQLEXPRESS;Database=master;Trusted_Connection=True;");
